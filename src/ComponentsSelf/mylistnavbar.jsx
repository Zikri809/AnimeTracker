...
return (
    <nav className="fixed border-0 border-gray-700 z-3 bg-black w-screen overflow-x-hidden pl-1 sm:pl-4 h-12 px-2 pr-4 pt-3 top-0 left-0 flex flex-row items-center justify-between">
